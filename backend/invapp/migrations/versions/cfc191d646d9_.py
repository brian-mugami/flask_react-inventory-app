...
Revision ID: cfc191d646d9
Revises: 4fdcece6fbd1
Create Date: 2023-03-20 01:29:42.246246
...
revision = 'cfc191d646d9'
down_revision = '4fdcece6fbd1'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('customers', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('customers_account_id_fkey', 'customer_account', ['account_id'], ['id'], ondelete='SET DEFAULT')
    ...
    sa.PrimaryKeyConstraint('id', name='customer_account_pkey'),
    sa.UniqueConstraint('account_name', name='customer_account_account_name_key'),
    sa.UniqueConstraint('account_number', name='customer_account_account_number_key')
    )
    # ### end Alembic commands ###
