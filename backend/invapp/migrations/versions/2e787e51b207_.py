...
Revision ID: 2e787e51b207
Revises: 
Create Date: 2023-03-20 11:00:35.554075
...
def upgrade():
    ...
    sa.Column('date_registered', sa.DateTime(), nullable=True),
    sa.Column('date_archived', sa.DateTime(), nullable=True),
    sa.Column('account_id', sa.Integer(), server_default='2', nullable=False),
    sa.Column('date_unarchived', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['account_id'], ['customer_account.id'], ondelete='SET DEFAULT'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('account_id'),
    ...
    sa.Column('category_id', sa.Integer(), server_default='8', nullable=False),
