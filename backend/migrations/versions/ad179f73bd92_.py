...
Revision ID: ad179f73bd92
Revises: 0fa1968f0252
Create Date: 2023-04-14 10:50:47.081109
...
revision = 'ad179f73bd92'
down_revision = '0fa1968f0252'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['credit_account_id'], ['accounts.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['debit_account_id'], ['accounts.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['payment_id'], ['supplier_payments.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.execute('DROP TABLE "customer balances" CASCADE;')
